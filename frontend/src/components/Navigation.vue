      ...
      <div class="flex flex-1 items-center justify-end md:justify-between">
        <nav aria-label="Global" class="hidden md:block">
          <ul class="flex items-center gap-6 text-sm">
            <li>
              <a class="text-gray-500 transition hover:text-gray-500/75" href="#">Пункт 1</a>
            </li>
  
            <li>
              <a class="text-gray-500 transition hover:text-gray-500/75" href="#">Пункт 2</a>
            </li>
  
            <li>
              <a class="text-gray-500 transition hover:text-gray-500/75" href="#">Пункт N</a>
            </li>
          </ul>
        </nav>
